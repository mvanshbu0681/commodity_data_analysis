      ...
      <div className="flex items-center ml-auto">
        ...
        <div className="relative flex items-center">
          <input
            type="text"
            id="search-navbar"
            className="block w-full p-2 text-sm border border-gray-300 rounded-lg bg-gray-50 pl-10 focus:ring-blue-500 focus:border-blue-500 border-black" // Add the border-black class here
            placeholder="Search..."
          />
          <svg
